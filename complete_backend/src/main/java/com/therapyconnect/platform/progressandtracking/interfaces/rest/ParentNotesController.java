...
import com.therapyconnect.platform.progressandtracking.application.queryservices.ParentNoteQueryService;
import com.therapyconnect.platform.progressandtracking.domain.model.commands.DeleteNoteCommand;
import com.therapyconnect.platform.progressandtracking.domain.model.queries.GetAllParentNotesByAuthorProfileIdQuery;
import com.therapyconnect.platform.progressandtracking.domain.model.queries.GetAllParentNotesQuery;
import com.therapyconnect.platform.progressandtracking.domain.model.queries.GetParentNoteByIdQuery;
import com.therapyconnect.platform.progressandtracking.interfaces.rest.resources.CreateParentNoteResource;
...
import com.therapyconnect.platform.progressandtracking.interfaces.rest.transform.CreateParentNoteCommandFromResourceAssembler;
import com.therapyconnect.platform.progressandtracking.interfaces.rest.transform.ParentNoteResourceFromEntityAssembler;
import com.therapyconnect.platform.progressandtracking.interfaces.rest.transform.UpdateParentNoteCommandFromResourceAssembler;
    ...
    public ResponseEntity<?> createParentNote(@RequestBody CreateParentNoteResource resource) {
        ...
        var result = parentNoteCommandService.handle(createParentNoteCommand)
                .flatMap(noteId -> parentNoteQueryService.handle(new GetParentNoteByIdQuery(noteId))
                        .<Result<com.therapyconnect.platform.progressandtracking.domain.model.aggregates.ParentNote, ApplicationError>>
                                map(Result::success)
